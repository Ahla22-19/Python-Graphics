...
A collection of animated scenes built with Python graphics. This is my first programming project, featuring four distinct animations.

---

📌 Overview

This project showcases four animated scenes created using Python's graphics library. Each scene demonstrates object movement, looping animations, and interactive storytelling.
...
Ahla22-1
First programming project — built with curiosity and creativity.
...
© First Project — Learning Python Through Animation
